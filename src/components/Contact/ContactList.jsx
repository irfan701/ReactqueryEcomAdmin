...
export default function ContactList(){
    ...
    const {isFetching, isLoading, isError, error, data: contacts} =
        useQuery({
            queryKey: ["contacts", pageNo, perPage, searchKeyword],
                        ...
                        <div className="card">
                            <div className="card-body">
                                <div className="container-fluid">
                                    <div className="row">
                                        <div className="col-4">
                                            <h5>Category Two List - {contacts.total}</h5>
                                        </div>
                                            ...
                                            <div className="table-responsive table-section">
                                                <table className="table ">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Mobile</td>
                                        ...
                                        <div className="col-12 mt-5">
                                            <nav aria-label="Page navigation example">
                                                ...
                                                <PaginationControl
                                                    ...
                                                    page={pageNo}
                                                    between={5}
                                                    total={Math.ceil(contacts.total)}
                                                    limit={perPage}
